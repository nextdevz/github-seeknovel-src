...
CREATE TABLE `nv_members` (
  ...
  `white_paw` int(10) unsigned NOT NULL DEFAULT '0',
  `black_paw` int(10) unsigned NOT NULL DEFAULT '0',
  `gold_paw` int(10) unsigned NOT NULL DEFAULT '0',
  ...
  KEY `white_paw` (`white_paw`),
  KEY `black_paw` (`black_paw`),
  KEY `gold_paw` (`gold_paw`),
